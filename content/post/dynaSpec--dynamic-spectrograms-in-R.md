...
[`color_spectro()`](https://marce10.github.io/warbleR/reference/color_spectro.html) function from
...
We can wrap the [`color_spectro()`](https://marce10.github.io/warbleR/reference/color_spectro.html) call using the [`call()`](https://rdrr.io/r/base/call.html) function form
...
functions (i.e. [`text()`](https://rdrr.io/r/graphics/text.html), [`lines()`](https://rdrr.io/r/graphics/lines.html)) in a single function and then save
...
call from [`text()`](https://rdrr.io/r/graphics/text.html). This let users customize things as size, color,
position, font, and additional arguments taken by [`text()`](https://rdrr.io/r/graphics/text.html). The call
...
The argument accepts more than one labels as in a regular [`text()`](https://rdrr.io/r/graphics/text.html) call.
...
<font size="4">Session information</font>
    ...
    ##  [9] pbapply_1.7-0   tools_4.2.2     parallel_4.2.2  xfun_0.39      
    ## [13] dtw_1.23-1      cli_3.6.1       htmltools_0.5.5 yaml_2.3.7     
    ## [17] digest_0.6.31   brio_1.1.3      bitops_1.0-7    RCurl_1.98-1.12
    ## [21] testthat_3.1.8  signal_0.7-7    evaluate_0.21   rmarkdown_2.21 
    ## [25] proxy_0.4-27    compiler_4.2.2  fftw_1.0-7
